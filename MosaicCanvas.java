package com.example.myartifact;
...
/**
 *  A com.example.myartifact.MosaicCanvas object represents a grid containing rows
...
public class MosaicCanvas extends Canvas {
     ...
     /**
      *  Construct a com.example.myartifact.MosaicCanvas with 42 rows and 42 columns of rectangles,
     ...
     /**
      *  Construct a com.example.myartifact.MosaicCanvas with specified numbers of rows and columns of rectangles,
      *  and with preferred rectangle height and width both set to 16.
      */
     ...
     /**
      *  Construct a com.example.myartifact.MosaicCanvas with the specified number of rows and
     ...
     /**
      * Given an x-coordinate of a pixel in the com.example.myartifact.MosaicCanvas, this method returns
     ...
     /**
      * Given a y-coordinate of a pixel in the com.example.myartifact.MosaicCanvas, this method returns
...
} // end class com.example.myartifact.MosaicCanvas